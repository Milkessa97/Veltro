...
import { GithubIcon } from "./LandingPage/icons"
import Link from "next/link"

export function HeroSection() {
  return (
      <section
  className="relative flex flex-col items-center text-center w-full min-h-screen min-h-[100dvh] overflow-hidden my-0 py-0 px-4 md:px-0 rounded-b-[10px] md:rounded-b-[15px] lg:rounded-b-[20px] border-b border-border/20 bg-background/50"
>      {/* SVG Background (full-bleed) */}
      <div className="absolute left-1/2 -translate-x-1/2 w-screen inset-0 z-[-20]">
        <svg
          width="100%"
          height="100%"
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.578125" stopColor="hsl(239 60% 20%)" />
            ...
            >
              <stop stopColor="hsl(var(--background))" />
              <stop offset="0.578125" stopColor="hsl(239 55% 18%)" />
            ...
            >
              <stop stopColor="hsl(var(--background))" />
              <stop offset="0.578125" stopColor="hsl(239 50% 22%)" />
            ...
            >
              <stop stopColor="hsl(var(--background))" />
              <stop offset="0.157789" stopColor="hsl(239 55% 18%)" />
  ...
  <div className="h-24 md:h-28 w-full shrink-0" />

  <div className="flex-1 flex flex-col z-40 items-center justify-center gap-5 md:gap-6 lg:gap-8 px-6 md:px-10 lg:px-12 py-8 max-w-4xl mx-auto">
    <h1 className="text-foreground text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight md:tracking-[-0.035em] leading-[1.1] md:leading-[1.05] text-balance">
      Measure cycle time. Unblock reviews. Ship faster.
    </h1>
    <p className="text-muted-foreground/90 text-base md:text-lg lg:text-xl font-medium leading-relaxed max-w-[60ch] mx-auto text-pretty">
      Veltro turns your GitHub activity into clear signals, tracking cycle time, surfacing review bottlenecks, and
      sending AI digests so your team always knows what to fix next.
    </p>
    <Link href="/login" className="mt-2 md:mt-3">
      <Button className="relative z-40 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 flex items-center gap-2">
  ...
  <div className="h-[260px] md:h-0 w-full shrink-0" />
