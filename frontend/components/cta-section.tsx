...
export function CTASection() {
  return (
    <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-[65ch] mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight md:tracking-[-0.035em] leading-[1.1] md:leading-[1.08] break-words max-w-[520px] text-balance">
            Know your team&apos;s pulse
          </h2>
          <p className="text-muted-foreground/90 text-base md:text-lg font-medium leading-relaxed max-w-[55ch] text-pretty">
            Connect a GitHub repo and get cycle time, review bottlenecks, and AI digests in minutes. No agents to
            install, no data to wrangle.
          </p>
        </div>
        <Link href="/login">
          <Button
